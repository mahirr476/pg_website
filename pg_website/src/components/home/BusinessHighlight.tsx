...
//   // Function to safely format the image URL
...
//     // For relative paths, use a placeholder or a default image
//     return '/images/business/placeholder.jpg';
//   };
...
//           className="text-center mb-16"
//         >
//           <h2 className="text-4xl font-bold mb-4 text-company-royal">{businessHero?.title || ""}</h2>
//           <p className="text-gray-600 max-w-2xl mx-auto text-lg">
...
//                   <div className="p-6">
//                     <h3 className="text-xl font-bold mb-2 text-company-royal">{business.title}</h3>
//                     <p className="text-gray-600 mb-4">{business.shortDes}</p>
//                     <Link href={`/business-activities/${business.id}`}>
//                       <Button 
//                         variant="ghost" 
//                         className="group hover:text-company-orange"
//                       >
