...
//   // Process API images using centralized utility
//   const processAllImages = (heroes: Hero[]): string[] => {
//     const allImages: string[] = [];
    
//     heroes.forEach(hero => {
//       if (hero.images && hero.images.length > 0) {
//         const formattedUrls = formatImageUrls(hero.images);
//         allImages.push(...formattedUrls);
//       }
//     });
...
//   const allImages = processAllImages(heroes);

//   // Test image URLs and filter working ones using centralized utility
//   useEffect(() => {
//     const testImages = async () => {
//       const workingUrls: string[] = [];
      
//       // Test each image URL using centralized utility
//       for (const imageUrl of allImages) {
//         const isWorking = await getFirstWorkingImage([imageUrl]);
//         if (isWorking) {
//           workingUrls.push(imageUrl);
//         }
//       }
...
//       setWorkingImages(workingUrls);
//       console.log(`HomeHero - Found ${workingUrls.length} working images out of ${allImages.length} total`);
//     };
...
//                 sizes="100vw"
//                 onError={(e) => {
//                   console.error(`HomeHero - Image failed to load: ${workingImages[currentImageIndex]}`);
//                 }}
//                 onLoad={() => {
//                   console.log(`HomeHero - Image loaded successfully: ${workingImages[currentImageIndex]}`);
//                 }}
//               />
