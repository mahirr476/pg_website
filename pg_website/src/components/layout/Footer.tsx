  ...
  return (
    <footer className="bg-gray-50 border-t">
      <div className="container mx-auto px-4">
        ...
        <div className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            {/* Company Info Column - Center aligned on mobile */}
            <div className="lg:col-span-2 text-center md:text-left">
              ...
              <div className="space-y-3">
                {contactInfo.map((item, index) => (
                  <div key={index} className="flex items-center justify-center md:justify-start space-x-3 text-gray-600">
                    {item.icon}
                    <span className="text-center md:text-left">{item.info}</span>
                  </div>
                ))}
              </div>
            </div>

            {/* Quick Links - Center aligned on mobile */}
              ...
              <ul className="space-y-2">
                {quickLinks.about.map((link, index) => (
                  <li key={index}>
                    <Link 
                      href={link.href}
                      className="text-gray-600 hover:text-primary inline-flex items-center justify-center md:justify-start"
                    >
                      <ArrowRight className="w-4 h-4 mr-1" />
                      {link.label}
                    </Link>
        ...
        {/* Bottom Bar - Center aligned on mobile */}
        <div className="border-t py-8">
